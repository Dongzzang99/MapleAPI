...
function createStatContainer(statList, characterData, backgroundColor) {
    ...
    container.style.flexWrap = 'wrap'; // 두 열로 나뉨
    container.style.backgroundColor = backgroundColor;
    container.style.padding = '8px'; // 내부 패딩
    container.style.borderRadius = '10px'; // 둥근 테두리
    container.style.marginBottom = '10px'; // 컨테이너 간의 간격 최소화
